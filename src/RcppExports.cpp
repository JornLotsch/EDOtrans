...
RcppExport SEXP _EDOtrans_findMatchingSeedsCpp(SEXP candidatesSEXP, SEXP targetStateSEXP, SEXP verboseSEXP, SEXP progressEverySEXP) {
BEGIN_RCPP
...
RcppExport SEXP _EDOtrans_findMatchingSeedsBatchCpp(SEXP candidatesSEXP, SEXP targetStateSEXP, SEXP batchSizeSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type candidates(candidatesSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_EDOtrans_findMatchingSeedsCpp", (DL_FUNC) &_EDOtrans_findMatchingSeedsCpp, 4},
    {"_EDOtrans_findMatchingSeedsBatchCpp", (DL_FUNC) &_EDOtrans_findMatchingSeedsBatchCpp, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_EDOtrans(DllInfo *dll) {
